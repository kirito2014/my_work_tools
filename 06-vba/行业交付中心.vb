...
For i = 3 To maxdeptrow
    ...
    savefilename = filepath & "\" & curntdeptname & "_行业交付中心考核表.xlsx"
...
'GetArray（sheet("1"),0）功能表_部门
    ...
    savefilename = xpath & "\" & deptname & "_行业交付中心考核.xlsx"
    ...
    'Application.Visible = False
        ...
        '挨个打开sheet页对每个sheet页的名字进行判断，满足条件sheets.name = "说明"或sheets.index = 1则加为第一张,同理附件作为最后进行，其他sheet页判断名字并指定插入顺序
            ...
            For Each Sheet In ActiveWorkbook.Sheets
                ...
                i = Workbooks(deptname & "_行业交付中心考核.xlsx").Sheets.Count
                
                Debug.Print Sheet.Name
                
                Sheet.Copy After:=Workbooks(deptname & "_行业交付中心考核.xlsx").Sheets(1)
                ...
                Sheet.Copy After:=Workbooks(deptname & "_行业交付中心考核.xlsx").Sheets(i)
                ...
                '当sheet不是附件页的时候，判断后缀是否是部门号，再进行前缀判断
                    ...
                    If GetArray(Sheet.Name, 1) = deptname Then
                        ...
                        If GetArray(Sheet.Name, 0) = "行业交付中心战略执行考核" Then
                        ...
                        ElseIf GetArray(Sheet.Name, 0) = "客户2.0战略执行协作" Then
    ...
    Workbooks(deptname & "_行业交付中心考核.xlsx").Sheets(1).Delete '删除自带的sheet1表格
    
    Workbooks(deptname & "_行业交付中心考核.xlsx").Close Savechanges:=True '保存并关闭合并的表格
...
arryyy = "说明,考核指标,行业交付中心战略执行考核,客户2.0战略执行过程,客户2.0战略执行协作,客户2.0战略执行结果,解决方案和产品创新2.0战略执行,组织2.0战略执行"
...
'///打开合并工作簿，对文件夹下的文件进行合并按照给定的排序顺序进行排序
    ...
    openfilename = ypath & "\" & deptname & "_行业交付中心考核.xlsx"
