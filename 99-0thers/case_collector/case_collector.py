...
class App():
    def __init__(self, root):
        ...
        # Load the image and resize it to 30% of the original size
        original_logo = Image.open("res/sunline_logo_original.png")
        resized_logo = original_logo.resize((int(original_logo.width * 0.5), int(original_logo.height * 0.5)))
        ...
        self.logo_label.place(x=10, y=10)  # Adjust position as needed

        self.folder_var = tk.StringVar()
        self.target_file_var = tk.StringVar()

        frame = tk.Frame(self.root)
        frame.pack(pady=20, anchor="n")
