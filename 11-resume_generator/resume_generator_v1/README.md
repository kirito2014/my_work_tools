...
pyinstaller  --onefile --windowed  --console --name "简历生成器" --add-data "resources/icons/sunline.ico;resources/icons" --add-data "resources/bank_pics;resources/bank_pics" --add-data "template;template" --add-data "config;config" --add-data "check_ui.py;." --add-data "package/functions/batch_render_from_docx.py;." --add-data "package/functions/batch_render_from_docx.py;package/functions" --add-data "package/functions/get_emp_list.py;." --add-data "package/functions/get_emp_list.py;package/functions" --add-data "package/functions/check_resume_valid.py;." --add-data "package/functions/check_resume_valid.py;package/functions" --add-data "package/functions/add_special_info.py;package/functions"  --add-data "package/functions/key_map_convert.py;package/functions"  --add-data "package/functions/render_2_excel.py;package/functions"  --add-data "package/functions/merge_files.py;package/functions"  --add-data "package/functions/doc_2_json_alter.py;package/functions" --add-data "package/utils/icon_converter.py;package/utils" --hidden-import "package.functions.doc_2_json" --hidden-import "package.functions.add_special_info" --hidden-import "package.functions.render_from_docx" --hidden-import "package.functions.key_map_convert" --hidden-import "package.functions.batch_render_from_docx" --hidden-import "package.functions.get_emp_list" --hidden-import "package.functions.check_resume_valid" --hidden-import "package.functions.excel_2_json" --hidden-import "package.utils.excel_reader" --hidden-import "package.functions.render_2_excel" --hidden-import "package.functions.doc_2_json_alter" --hidden-import "package.functions.merge_files"  --icon "resources/icons/sunline.ico" --version-file version_info.txt  resume_gui.py 
